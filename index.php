...
<html>
    ...
    <style>
            ...
            #back-to-top {color:violet;padding: 8px 10px; font-size:24px; text-decoration: none;}
    ...
    <body style="background-image: url('https://images6.alphacoders.com/108/thumb-1920-1082090.jpg');">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-danger">
                <a class="navbar-brand" href="#" style="margin-left:15px;"><img src="img/Logo.png" title="odycraft" width="155"></a>
    ...
    <div class="container">
        <div class="h-100 p-5 text-white bg-dark">
            ...
            <p>Dan terima kasih anda telah berkunjung di forum ini!<br>Join minecraft copy alamat dan pastekan alamat server minecraftnya<br>Dibawah sini!<br>IP:<span class="blink">  <script language="javascript" type="text/javascript">
